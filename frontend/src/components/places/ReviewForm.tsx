...
export function ReviewForm({ place, onCancel, onSubmitted }: { place: Place; onCancel: () => void; onSubmitted: () => void }) {
  ...
  return <div className="page-scroll">
    ...
    <form onSubmit={submit} className="review-form card form-card" aria-busy={pending}>
      <fieldset disabled={pending}>
        ...
        <button type="submit" className="primary-action">{pending ? 'Mengirim review…' : 'Kirim Review'}</button>
      </fieldset>
